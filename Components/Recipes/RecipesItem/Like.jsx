...
import style from '../../More Recipes/more.module.scss'



const Like = ({isCompleted, likeClick, posts}) => {


    return (
        <>
            {isCompleted ? <div className={`${style.like} ${styles.like}`}>
                    <svg onClick={() => likeClick(posts)}
                ...
                :
                <div className={`${style.like} ${styles.like}`}>
                    <svg onClick={() => likeClick(posts)}
                         width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
