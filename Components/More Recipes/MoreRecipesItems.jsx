...
import Like from "../Recipes/RecipesItem/Like";
            ...
            {loading ? "Loading..." : post.map(({_id, img, title, tag, time, isCompleted}) => (
                <div  className={styles.item}
                    ...
                    <div className={styles.img}>
                        <Image src={'/img/' + img} alt={title} width={290} height={200} loading={"lazy"}/>
                        <Like
                            posts={_id}
...
export default MoreRecipesItems;
